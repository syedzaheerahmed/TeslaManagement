...
public class TransactionReportServiceImpl implements TransactionReportService {
    ...
    public TransactionReportDTO generateTransactionReport(Date fromDate) {
        ...
        List<Transactions> validTransactions = transactionsRepository.findByTransactionDateGreaterThanEqualAndIsInvalidTransactionFalse(fromDate);
        ...
        for (Transactions transaction : validTransactions) {
    ...
    private TransactionDetailDTO mapTransactionToDetailDTO(Transactions transaction) {
